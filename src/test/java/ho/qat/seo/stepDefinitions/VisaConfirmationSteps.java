...
public class VisaConfirmationSteps {
    ...
    AnotherTypeOfJob anotherTypeOfJob;
    ...
    @And("I select type of job to {string}")
    public void iSelectIWantToDoAnotherTypeOfJob(String type) {
        anotherTypeOfJob.selectReasonForJob(type);
        anotherTypeOfJob.clickNextStepButton();
    }
}
